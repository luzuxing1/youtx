<!DOCTYPE html>
<!-- saved from url=(0044)http://www.youtx.com/room/newcomplete/324548 -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<#assign base=request.contextPath />
    <base id="base" href="${base}">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="Cache-Control" content="max-age=86400">
    <img src="${base}/static/publish_house_complete/countpv" width="0" height="0"><script charset="utf-8" src="${base}/static/publish_house_complete/v.js.下载"></script><script type="text/javascript" async="" src="${base}/static/publish_house_complete/load.min.js.下载"></script><script src="${base}/static/publish_house_complete/jquery-1.6.2.min.js.下载" language="javascript" type="text/javascript"></script>
    <script src="${base}/static/publish_house_complete/jQuery.cookie.js.下载" language="javascript" type="text/javascript"></script>
    <link href="${base}/static/publish_house_complete/public.css" rel="stylesheet" type="text/css"> 
    ...
    <title>
        游天下-发布房间-发布完成</title>
    <link href="${base}/static/publish_house_complete/DescriptionenNew.css" type="text/css" rel="stylesheet">

   
<script src="${base}/static/publish_house_complete/saved_resource"></script><link rel="stylesheet" type="text/css" href="${base}/static/publish_house_complete/Youtx_WebIM.css"></head>
<body>
...
<script type="text/javascript" src="${base}/static/publish_house_complete/Login_Cookie.js.下载"></script>
<script type="text/javascript">
    //监控代码请勿删除
...
<div id="youtxlogin" class="header" style="">
    <p class="logo">
        <a href="http://www.youtx.com/" id="youtx_01" target="_blank"><img src="${base}/static/publish_house_complete/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<!--        <li class="PosRe"><a href="http://www.youtx.com/mo/" target="_blank"  rel="nofollow" id="youtx_04">手机游天下</a></li>-->
        <li><a href="http://www.youtx.com/profile/BookingTeam" target="_blank">团队订房</a><img alt="新" src="${base}/static/publish_house_complete/NewIco.gif" style="display:none;left:45px;" class="PosAb TN17"></li>
        ...
        <div class="ytxMobCon" style="display:none">
            ...
            <dl>
            	<dt>扫描二维码安装游天下客户端</dt>
                <dd><a href="http://www.youtx.com/mo/" target="_blank"><img src="${base}/static/publish_house_complete/youtxapp.png" width="120" height="120"></a></dd>
            </dl>
            <dl>
            	<dt><span class="ColorBlue">微信</span>扫描二维码使用游天下</dt>
                <dd><img src="${base}/static/publish_house_complete/ewmBNew.jpg" width="102" height="102"></dd>
                <dd>微信公众号：游天下</dd>
            </dl>
...
<div id="youtxloginw" class="header" style="display: none;">
    <p class="logo">
        <a href="http://www.youtx.com/" target="_blank" id="youtx_01">
            <img src="${base}/static/publish_house_complete/logo.jpg" alt="游天下 搜房网旗下-专业短租房、日租房网站" title="游天下 搜房网旗下-专业短租房、日租房网站"></a>
    </p>
    <!--2013-5-3修改-->
...
<script type="text/javascript">
    ...
    <div class="wrapper">
        <form method="post" action="http://www.youtx.com/room/newcomplete/324548" id="form1">
            <div class="aspNetHidden">
                <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJMTAyNzgxMjkzZGQH9s+9UGPNJlA2lbX13hQzkByQkuJUv0vQnQ7TUE00Bg==">
            </div>
            <div class="aspNetHidden">
                <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWAwKC1f7KCAKAv/G0AQLv47irBKoQ+iM4J9jgpcj/lcXRbkD5TpRlaw4nQtQW462zVO5q">
            </div>
            <!--主要内容 begin-->
            <div class="Description">
                ...
                <div class="ReleaseProcess">
                    <h1>
                        发布您的房间 简单发布，轻松出租，让您的房子每天帮您赚钱</h1>
                    <a href="http://www.youtx.com/help/Manage/" target="_blank" class="ProcessDetail">
                        了解详情&nbsp;&gt;&gt;</a>
                </div>
                <!--发布头部 end-->
                <!--第一步 begin-->
                <div class="post_room_step1 post_roomNew_step1">
                    <!--发布模块 begin-->
                    <div class="issuance_top clearfix">
                        <ul>
                            <li class="issuance_right"></li>
                            <li class="issuance_text">
                                恭喜，发布成功！房间已提交审核，需要约一个工作日，请耐心等待…</li>
                        </ul>
                    </div>
                    ...
                    <div class="TeachDesc">
                        ...
                        <ul class="clearfix">
                            ...
                            <li class="ssg"></li>
                            <li class="TeaItem2"><span>如何吸引租客</span><a href="http://www.youtx.com/houseRank/">搜索排名优化</a></li>
                            
                            <li class="ssg"></li>
                            <li class="TeaItem3"><span>做自己的短租品牌</span>
                                
                                <a href="http://www.youtx.com/mallshop/mallabout/">我要开店</a>
                    ...
                    <p style="text-align: center; padding-top: 80px;">
                        为了确保您的交易利益不受损失，游天下建议您与租客在线完成交易<a href="http://www.youtx.com/OrderAdvantage/" target="_blank" class=" ML20">在线交易的好处</a>
                    </p>
                ...
                <!--提交按钮 end-->
                <!--错误提示 begin-->
                <div style="display: none" id="error_summary">
                    <p>
                        请更正以下错误：
                    </p>
                    <ul>
...
<!--尾部2011-9-6修改 start-->
    ...
    <ul class="footer_link">
      ...
      <li class="footer_link_space">|</li>
      <li class="footer_link_grey footer_link_space" style="margin: 0;">客服热线：400-630-0088，客服邮箱：<span>service</span> <img src="${base}/static/publish_house_complete/at.jpg"> <span>youtx.com</span></li>
    </ul>
    ...
    <ul class="FooterNet">
      ...
      <li><a target="_blank" href="https://trustsealinfo.verisign.com/splash?form_file=fdf%2Fsplash.fdf&amp;sap=&amp;dn=passport.youtx.com&amp;zoneoff=&amp;lang=zh_CN" rel="nofollow"><img src="${base}/static/publish_house_complete/VerisignYoutx.gif" height="35" width="60"></a></li>
      <li><a href="https://www.itrust.org.cn/yz/pjwx.asp?wm=1766253730" rel="nofollow" target="_blank"><img src="${base}/static/publish_house_complete/FooterNetPic.gif"></a></li>
      <li><a target="_blank" href="https://ss.knet.cn/verifyseal.dll?sn=e12032211010015160307708&amp;ct=df&amp;pa=318891" rel="nofollow"><img src="${base}/static/publish_house_complete/TrustYoutx.gif" width="100" height="35px"></a></li>
    </ul>
  </div>
<!--2013-6-26修改-->
<script type="text/javascript">
...
</script><script src="${base}/static/publish_house_complete/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=eb4b7b326a601c545c14e8b6b965e4a0" target="_blank"><img border="0" src="${base}/static/publish_house_complete/21.gif" width="20" height="20"></a>
...
<script type="text/javascript" src="${base}/static/publish_house_complete/conversion.js.下载">
</script>
<noscript>
...
<script type="text/javascript" src="${base}/static/publish_house_complete/rt.js.下载"></script>
<noscript>
