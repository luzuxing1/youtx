...
(function ($) {
    ...
    imageCropper.prototype = {
        ...
        init: function (image, settings) {
            ...
            //生成html
            image.wrap(this.wrapper).wrap('<div class="crop-work-area"/>').wrap('<div id="divCropBackground" class="crop-background"/>');
            ...
            if (this.settings.imgWidth >= this.settings.width && this.settings.imgHeight >= this.settings.height) {
                this.wrapper.append($('<div class="zoom-wrapper"><div class="zoom-out-button"/><div class="zoom-scrollbar"><div class="zoom-scroller"/></div><div class="zoom-in-button"/></div>'));
            }
            ...
            if (engine == 7 || this.settings.imgWidth < this.settings.width || this.settings.imgHeight < this.settings.height) {
                $("#divCropBackground").hide();
            }
        },
        reset: function () {
            this.img = new Image(this.settings.imgWidth, this.settings.imgHeight);
