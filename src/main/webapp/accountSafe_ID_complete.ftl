...
<!-- saved from url=(0034)http://www.youtx.com/User/Profile/ -->
...
<script type="text/javascript">
  ...
  <!--内容右 start-->
          <div class="control_main_right">
            <div class="actSafety">
              	<h3 class="actSafetyTt">
                	<strong>您的安全级别：</strong>
                    
                            <span class="SafetyM">中</span>
                            
                </h3>
                <p class="actSafetyTt TaC">建议您启动全部安全设置，以保障账户及基金安全</p>
                <ul class="verifyList">
                    <li> 
                             <strong class="verifyNo">邮箱验证</strong>
                             <span></span>
                             <a href="http://www.youtx.com/profile/passport/MailVerify.aspx">验证</a> 
                         
                    </li>
                    <li>
                            <strong class="verifyYes">手机验证</strong>
                            <span>+86 176****2096</span> 
                            <a href="http://www.youtx.com/profile/passport/TelIdentityByTel.aspx">修改</a>
                          
                    </li>
                     <!--2015-11-26Begin-->
                   <li> 
                          <strong class="verifyYes">身份验证</strong>
                            <span>卢祖兴&nbsp;4115**************</span>
                            
                              <a href="javascript:void(0);" style="color:#999; cursor:default; text-decoration:none;">身份证</a> 
